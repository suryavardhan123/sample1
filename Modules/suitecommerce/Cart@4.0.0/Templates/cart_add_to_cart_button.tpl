...
{{#if itemid}}
	<div class="cart-add-to-cart-button-container">
		<input type="button" data-type="customadd" class="cart-add-to-cart-button-button" value = "Add to Cart" id="customadd" />
	<button type="submit" data-type="add-to-cart" style = "display:none;" id="addtocart">
