	...
	)
{
	...
	,	events: {
			...
			'click [data-type="customadd"]': 'customAddToCart'
		}
	...
	,	customAddToCart : function(){
			if (confirm("Are You Sure You Want To Add-To-Cart") == true) {
				$("#addtocart").click();
			} else {
				document.getElementById('customadd').disabled = true;
			}
	...
	,	getContext: function getContext ()
		{
			var itemid = this.model.get('item').get('internalid');
			//alert(itemid);
