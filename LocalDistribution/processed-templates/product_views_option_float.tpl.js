define('product_views_option_float.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = " <label class=\"product-views-option-float-label\" for=\""
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\"\n				></div></div></div>  ";
},"useData":true}); template.Name = 'product_views_option_float'; return template;});