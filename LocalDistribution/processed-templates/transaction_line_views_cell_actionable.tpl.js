define('transaction_line_views_cell_actionable.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = ((helper = (helper = compilerNameLookup(helpers,"linkAttributes") || (depth0 != null ? compilerNameLookup(depth0,"linkAttributes") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"linkAttributes","hash":{},"data":data}) : helper));
  if (stack1 != null) { buffer += stack1; }
  return buffer + " class=\"transaction-line-views-cell-actionable-name-link\"> "
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " ><td class=\"transaction-line-views-cell-actionable-table-first\"><div class=\"transaction-line-views-cell-actionable-thumbnail\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </div></td><td class=\"transaction-line-views-cell-actionable-table-middle\"><div class=\"transaction-line-views-cell-actionable-name\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </div><div class=\"transaction-line-views-cell-actionable-price\"><div data-view=\"Item.Price\"></div></div><div data-view=\"Item.Sku\"></div><div class=\"transaction-line-views-cell-actionable-options\"><div data-view=\"Item.SelectedOptions\"></div></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <div class=\"transaction-line-views-cell-actionable-stock\" data-view=\"ItemViews.Stock.View\"></div><div data-view=\"StockDescription\"></div></td><td class=\"transaction-line-views-cell-actionable-table-last\"><div data-view=\"Item.Actions.View\"></div> ";
