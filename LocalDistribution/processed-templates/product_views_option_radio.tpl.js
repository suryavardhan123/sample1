define('product_views_option_radio.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = " <div class=\"product-views-option-radio-label-header\"><label class=\"product-views-option-radio-label\" for=\""
  ...
  var stack1, helper, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, buffer = " <label data-label=\"label-"
  ...
  return buffer + " data-toggle=\"set-option\"\n							data-active=\""
    ...
    + "\"\n							class=\"product-views-option-radio-input\"><span class=\"product-views-option-radio-value\">"
    + escapeExpression(((helper = (helper = compilerNameLookup(helpers,"label") || (depth0 != null ? compilerNameLookup(depth0,"label") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"label","hash":{},"data":data}) : helper)))
    + "</span></label> ";
...
},"useData":true,"useDepths":true}); template.Name = 'product_views_option_radio'; return template;});