define('transaction_line_views_cell_navigable.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = " <a class=\"transaction-line-views-cell-navigable-product-title-anchor\" ";
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + " <span class=\"transaction-line-views-cell-navigable-item-reason-value\">"
  ...
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, lambda=this.lambda, buffer = " <tr class=\"transaction-line-views-cell-navigable "
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </p><p><div data-view=\"Item.Price\"></div></p><div data-view=\"Item.Sku\"></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <p><span class=\"transaction-line-views-cell-navigable-stock\" data-view=\"ItemViews.Stock.View\"></p><div data-view=\"StockDescription\"></div></td><td class=\"transaction-line-views-cell-navigable-item-unit-price\" name=\"item-totalprice\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </td><td class=\"transaction-line-views-cell-navigable-item-quantity\" name=\"item-quantity\"><p><span class=\"transaction-line-views-cell-navigable-item-quantity-label\">"
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <span class=\"transaction-line-views-cell-navigable-item-amount-value\">"
