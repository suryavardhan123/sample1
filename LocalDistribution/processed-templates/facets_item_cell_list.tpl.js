define('facets_item_cell_list.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + " <div data-view=\"ItemDetails.Options\"></div><div data-view=\"Cart.QuickAddToCart\"></div><div class=\"facets-item-cell-list-stock\"><div data-view=\"ItemViews.Stock\" class=\"facets-item-cell-list-stock-message\"></div></div><div data-view=\"StockDescription\"></div></div></div>  ";
